...
export function Poll() {
  ...
  return <form onSubmit={save} className="panel gold-border rounded-2xl p-5 sm:p-8">
    ...
    <section className="mt-6 rounded-xl border border-stone-700 bg-black/20 p-4 sm:p-5">
      ...
      <fieldset className="mt-5 rounded-xl border border-stone-700 bg-stone-950/35 p-4">
        <legend className="px-2 text-sm font-black text-stone-200"><span className="mr-2 text-amber-400">1.</span>Optional extra-day interest</legend>
        <p className="mb-3 text-xs text-stone-500">What would you consider joining? Select any. This is not a commitment.</p>
